...
// --- IMAGES IMPORT (CORRECTED NAMES) ---
// குறிப்பு: நீங்கள் சொன்னபடி 'rahaa.jpg' மற்றும் 'solar.jpg' என்று மாற்றியுள்ளேன்.
          ...
          <section id="home" className="min-h-screen flex flex-col justify-center items-center text-center px-4 pt-20 relative overflow-hidden">
            <div className="z-10 flex flex-col items-center max-w-5xl">
              ...
              >
                 ...
                 {/* HERO IMAGE (Still uses public folder) */}
                 <img src="/profile.jpg" alt="Ragul Dravid" className="relative w-40 h-40 md:w-48 md:h-48 object-cover object-top rounded-full border border-rahaa-gold grayscale-0 md:grayscale md:group-hover:grayscale-0 transition-all duration-700" />
              </motion.div>
             ...
             <div className="max-w-7xl mx-auto">
               ...
               <div className="space-y-32 mt-20">
                  <TiltProjectCard 
                    ...
                    image={rahaImg} // IMPORTED VARIABLE
                  />
                  <TiltProjectCard 
                    ...
                    image={solarImg} // IMPORTED VARIABLE
                  />
               </div>
             </div>
          </section>
